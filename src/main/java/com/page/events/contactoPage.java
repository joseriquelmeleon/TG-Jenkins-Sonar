...
public class contactoPage extends Base {
	...
	By messageLocator = By.cssSelector("#post-1487 > div > div > div > div.et_pb_section.et_pb_section_0.et_section_regular > div.et_pb_row.et_pb_row_0 > div > div > div > h1 > strong");
	...
	public void ContactoPage() throws InterruptedException {
		...
		if (isDisplayed(contactoLocator)) {
			System.out.println("*** (5/6) La pagina contacto esta funcionando correctamente ***");
			
		} else {
			System.out.println("*** (5/6) Hubo un problema con la pagina Contacto ***");
